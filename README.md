...
:rocket: Desafio 01: Conceitos do Node.js
...
<p align="center">
  ...
  <img alt="Language count" src="https://img.shields.io/github/repo-size/araujo-jp/conceitos-do-nodejs"/>

  <a href="https://github.com/araujo-jp">
    <img alt="João Paulo" src="https://img.shields.io/badge/made%20by-João Paulo Araújo-%237519C1">
  </a> 

  <a href="https://github.com/araujo-jp/conceitos-do-nodejs/commits/main">
    <img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/araujo-jp/conceitos-do-nodejs">
  </a>

  <img alt="License" src="https://img.shields.io/github/license/araujo-jp/conceitos-do-nodejs">
</p>

<h1 align="center">

<img src="./.github/cover.png" alt="conceitos-do-nodejs logo" width="1000px"/>

</h1>

## 🚀 Sobre o desafio ## 

O objetivo do desafio é criar uma aplicação para treinar o que aprendeu até agora no Node.js! 
...
**Observação:** O username deve ser enviado pelo header em uma propriedade chamada

<h1 align="center">

<img src="./.github/image-01.png" alt="conceitos-do-nodejs logo" width="500px"/>
...
```bash
# Clone this project
$ git clone https://github.com/araujo-jp/conceitos-do-nodejs.git
